...
import paramMapV1 from './paramMap'
import paramsArrayMap from './paramsArrayMap'
...
function parseLog(row) {
  ...
  let params = Array(21)
  params.fill(0)
  let dataParam:any = raw_params.get('data')
  if (dataParam) {
    dataParam = <String[]>dataParam.split(',')
    ...
    const _:any = parseLogV1(raw_params)
    params = [
      timestamp.valueOf(),
      0,
      0,
